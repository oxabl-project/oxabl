...
pub fn match_keyword(s: &str) -> Option<Kind> {
    ...
    match lower.as_str() {
        ...
        "exclusive" | "exclusive " | "exclusive l" | "exclusive lo" | "exclusive loc" | "exclusive lock" | "exclusive-lock" => Some(Kind::ExclusiveLock),
        ...
        "no lock" | "no-lock" => Some(Kind::NoLock),
        ...
        "share" | "share-" | "share-l" | "share-lo" | "share-loc" | "share lock" | "share-lock" => Some(Kind::ShareLock),
